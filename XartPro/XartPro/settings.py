"""
Django settings for XartPro project.
...
SECRET_KEY = '4hnp6$g6#nv2a_hp(pg5-64@-a*21st49wb1%*42_j1t$!y#&5'
...
WSGI_APPLICATION = 'XartPro.wsgi.application'
...
LOGGING = {
    ...
    'formatters': {  # 格式化
        'simple': {
            ...
            'datefmt': '%Y-%m-%d %H:%M:%S'  # time.strftime()/time.strptime()
        }
    },
    'handlers': {  # 处理器
        'console': {  # 控制台输出的处理器
